$( document ).ready(function() {
  ...
  // add toggle icons
  $( ".secondary .filters .collapsed .module-heading" ).append( '<i class="toggle-icon fa fa-chevron-right" aria-hidden="true"></i>' );

  $( ".secondary .filters .expanded .module-heading" ).append( '<i class="toggle-icon fa fa-chevron-down" aria-hidden="true"></i>' );
  ...
  $( ".secondary .filters .module-heading" ).click(function() {
    ...
    $(this).children(".toggle-icon").toggleClass( "fa-chevron-right fa-chevron-down" );
  });
